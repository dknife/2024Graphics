...
class MyGLWindow(QOpenGLWidget) :
    ...
    def initializeGL(self):
        ...
        glLightfv(GL_LIGHT1, GL_DIFFUSE, [0, 1, 1, 1.0])
        glLightfv(GL_LIGHT1, GL_SPECULAR, [0, 1, 1, 1.0])
    ...
    def paintGL(self):
        ...
        another_position = self.light_pos.copy()
        another_position[0] *= -1
        glLightfv(GL_LIGHT1, GL_POSITION, another_position )
